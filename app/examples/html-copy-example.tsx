    ...
    <div className="flex flex-col items-center gap-6 w-full max-w-2xl">
      ...
      >
        ...
        <p className="mb-4">
          ...
          <strong>CopyButton</strong> component! This component supports both{" "}
          <em>plain text</em> and <strong>rich HTML</strong> copying.
        </p>
        ...
        <blockquote className="border-l-4 border-blue-500 pl-4 italic text-gray-600 dark:text-gray-400">
          "This component makes copying content incredibly easy and
          user-friendly!"
        </blockquote>
      ...
      <div className="flex gap-4">
        <CopyButton htmlRef={htmlContentRef} className="flex-1" />
        <CopyButton
      ...
      <p className="text-sm text-muted-foreground text-center">
        The left button copies the rich HTML content above, the right button
        copies plain text
      </p>
    </div>
  )
