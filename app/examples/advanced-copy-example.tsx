...
export function AdvancedCopyExample() {
  ...
  return (
    <div className="flex flex-col items-center gap-6 w-full max-w-3xl">
      ...
      >
        <article className="prose dark:prose-invert max-w-none">
          ...
          <ol className="list-decimal list-inside space-y-2 mb-4">
            <li>
              Implemented new <strong>copy-to-clipboard</strong> functionality
            </li>
            <li>
              Added support for <em>HTML content preservation</em>
            </li>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900 border-l-4 border-yellow-400 p-4 mb-4">
            <p className="text-sm">
              <strong>💡 Pro Tip:</strong> This component automatically converts
              HTML to markdown when copying, making it perfect for documentation
      ...
      <CopyButton htmlRef={richContentRef} className="w-full max-w-xs" />

      <p className="text-sm text-muted-foreground text-center">
        This button copies the entire rich content above, including tables,
